...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/rajabatra/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |  7m56.02sec               |        65.83s             | 
| `pg_normalized_batch`  |  83.53s                   |        14.29s             | 
| `pg_denormalized`      |  17.32s                   |        4.37s              | 
